...
exptDManipulate[] := Manipulate[
   Module[{q = exptDModel[<|"h_km" -> h, "mach" -> mach, "log10_ne" -> lne, "log10_S" -> lS, "delta_m" -> dl,
        "B_uT" -> bt, "mech" -> mech, "f_close" -> fcl, "m_t" -> mt, "A_s" -> as, "f_rx" -> frx, "aperture" -> ap,
        "SE_dB" -> se, "noise_env" -> env, "log10_eta" -> le, "chi" -> chi, "log10_kappa" -> lk, "r_km" -> rk|>],
     rr = 10.^Range[0., 3., 0.05]},
    Column[{
      Style["Experiment D SLW/SW detectability " <> exptDVersion <> " (FACT sheath + HYP Hively EED; not flight data)", Bold],
      Grid[{{"f_p (GHz)", q["fp_Hz"]/1.*^9}, {"nu (1/s)", q["nu_s"]}, {"J (A/m^2)", q["J_Am2"]},
        {"I_src rms (A)", q["Isrc_A"]}, {"sheath atten (dB)", q["Ash_dB"]}, {"floor Hively RX (dBm)", q["Nhiv_dBm"]},
        {"P_SLW (dBm)", q["Pslw_dBm"]}, {"SNR_SLW (dB)", q["SNR_slw_dB"]}, {"eta_th (SNR 0 dB)", q["eta_th0"]},
        {"P_SW proxy (dBm)", q["Psw_dBm"]}, {"P_TEM classical (dBm)", q["Ptem_dBm"]}, {"P_thermal (dBm)", q["Pth_dBm"]}},
       Frame -> All, Alignment -> Left],
      ListLogLinearPlot[{
        Table[{x, exptDModel[<|"h_km" -> h, "mach" -> mach, "log10_ne" -> lne, "log10_S" -> lS, "delta_m" -> dl,
             "B_uT" -> bt, "mech" -> mech, "f_close" -> fcl, "m_t" -> mt, "A_s" -> as, "f_rx" -> frx, "aperture" -> ap,
             "SE_dB" -> se, "noise_env" -> env, "log10_eta" -> le, "chi" -> chi, "log10_kappa" -> lk, "r_km" -> x|>]["Pslw_dBm"]}, {x, rr}],
        Table[{x, q["Nhiv_dBm"]}, {x, rr}]}, Joined -> True, PlotLegends -> {"HYP SLW", "floor"},
       AxesLabel -> {"r (km)", "dBm"}, ImageSize -> 480],
      Style["Cloud twin pending sync (" <> exptDVersion <> ")", Italic]}]],
   {{h, 70., "altitude (km)"}, 30., 90.}, {{mach, 25., "Mach"}, 5., 26.},
   {{lne, 18., "log10 n_e"}, 14., 20.}, {{lS, 6., "log10 shear S"}, 4., 8.}, {{dl, 0.01, "delta (m)"}, 0.001, 0.1},
   {{bt, 50., "B (uT)"}, 25., 65.}, {{mech, "vxB", "J mechanism"}, {"vxB", "diff"}}, {{fcl, 1., "J closure"}, 0.001, 1.},
   {{mt, 0.1, "dn/n"}, 0.01, 0.5}, {{as, 1., "sheet area (m^2)"}, 0.1, 10.},
   {{frx, 30.*^6, "f_rx (Hz)"}, {1.*^6, 30.*^6, 433.92*^6, 1296.*^6}}, {{ap, "hub", "SLW aperture"}, {"hub", "recip"}},
   {{se, 55., "RX TEM rejection SE (dB)"}, 0., 80.}, {{env, "quiet_rural", "ext noise"}, {"quiet_rural", "rural", "residential", "city", "none"}},
   {{le, -3., "log10 eta (SWEEP)"}, -12., 0.}, {{chi, 0., "chi (SWEEP)"}, 0., 1.}, {{lk, 0., "log10 kappa_C (SWEEP)"}, -12., 0.},
   {{rk, 100., "range (km)"}, 1., 1000.}, SaveDefinitions -> True];
