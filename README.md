...
python3 run_rx_analysis.py                  # results_rx.md / results_rx.json
node regress_v02.mjs                        # needs the v0.2 engines in /tmp/v02/js (git show 5fcaa60:js/...)
wolframscript -file ../wolfram/ExptDRx_RunGrid.wl && node compare_outputs.mjs js_rx_outputs.json wl_rx_outputs.json 1e-9   # owed
```
